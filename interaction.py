...
def interaction(rol):
    ...
    if st.session_state.pagina_actual == "inicio":
        ...
        if cola.button("Ver **Pagos y Recaudación**", use_container_width=True, type="primary", icon=":material/account_balance:",
        ...
        elif cold.button("Ver **Actividad de Fiscalización**", use_container_width=True, type="primary", icon=":material/computer:",
